...
<script>
    function addUser() {
        ...
        var url = '${ctxPath}/srv/user/add.action';
        var params = {
            username: username,
            fullname: fullname,
            fixtel: fixtel,
            ...
            <div class="tab-pane active in" id="tab_1">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input id="username" maxlength="4" itype="integer" name="username"
                                   type="text"
                                   class="form-control"
                                   value=""
                                   autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="userflag" value="0"> 停用
                                <span></span>
                            </label>
...
<div class="modal-footer">
    <a href="javascript:void(0)" onclick="addUser()" class="btn btn-primary">保存</a>
