...
<script type="text/javascript"
        src="${zl.web.resource.address}/js/ueditor/ueditor.config.js?version=${zl.web.resource.version}"></script>
<script type="text/javascript"
        src="${zl.web.resource.address}/js/ueditor/ueditor.all.min.js?version=${zl.web.resource.version}"></script>
<script type="text/javascript"
        src="${zl.web.resource.address}/js/ueditor/lang/zh-cn/zh-cn.js?version=${zl.web.resource.version}"></script>
