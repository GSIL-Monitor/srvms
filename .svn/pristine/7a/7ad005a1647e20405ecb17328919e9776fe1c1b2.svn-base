...
<script language="javascript" src="${zl.web.resource.address}/js/nestable/jquery.nestable.js?version=${zl.web.resource.version}"></script>
</@override>
<@override name="cssfile">
<link rel="stylesheet" type="text/css" href="${zl.web.resource.address}/css/nestable.css?version=${zl.web.resource.version}">
</@override>
