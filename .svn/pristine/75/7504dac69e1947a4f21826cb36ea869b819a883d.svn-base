...
<script>
    ...
    function allRadioClick(e) {
        ...
        var totalamount = 0;
        // 修改所有的复选框
        $("table .shopData input[value='"+year+"']").each(function () {
    ...
    function radioClick(e) {
        ...
        $("#totalamount").html((((totalamount - oldPrice + newPrice) / 100).toFixed(2) ) + "元");
    }
        ...
        <div class="portlet light ">
            ...
            <div class="panel-body">
                <form action="${ctxPath}/renew/order/payAgainMerchantStandard.action" method="post" id="submitForm">
                    ...
                    <div class="col-md-12" style="padding-left: 0px">
                        <label class="control-label col-md-12"><h5 style="font-weight:bold"><img src="${ctxPath}/images/label.png" style="width: 5px;margin-right: 5px;"/>选择商户</h5></label>
                        <div class="col-md-12">
                            <div class="col-md-8" style="margin-bottom:15px;padding-left: 0px;">
                                ...
                                <button type="button" class="btn btn-primary" onclick="singleShop()"><span style="color: white">+选择商户</span></button>
...
<@override name="window">
    <#include "../choose_wechat_shop.ftl" />
</@override>
