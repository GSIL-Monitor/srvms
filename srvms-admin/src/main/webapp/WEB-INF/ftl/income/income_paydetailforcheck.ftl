...
<script>
    function search() {
        $("#searchForm").attr('action', '${ctxPath}/service/serviceincome/payBillDetailforcheck.action');
        $("#searchForm").submit();
    }

    function exportExcel() {
        $("#searchForm").attr('action', '${ctxPath}/service/serviceincome/payBillDetailExport.action');
        var pageform = $('.tdtd')[0];
    ...
    <div class="col-md-12">
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <form class="search-form form-horizontal" action="${ctxPath}/service/serviceincome/payBillDetail.action"
                      id="searchForm"
                      method="post">
                    ...
                    <input type="hidden" id="servercode" name="servercode"
                           value="${servercode!''}" class="servercode">
