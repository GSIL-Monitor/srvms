    ...
    <table class="table table-hover table-bordered">
        ...
        <#if pageInfo?? && pageInfo.list??>
            ...
            <tr class="odd gradeX">
                ...
                <td> ${srv.serverusername!''}</td>
                <td> ${srv.serverarea!''}</td>
                <td> ${srv.shopcode!''}</td>
                <td> ${srv.shopname!''}</td>
                <td> ${srv.shoparea!''}</td>
                <td>
                ...
                <td>
                    <#if srv.status==0>
                        <a href="javascript:goto('${ctxPath}/srv/association/shop/manage/detail.action?id=${srv.id!''}','searchForm');"
                           class="primary-link">审核
                        </a>
                    </#if>
