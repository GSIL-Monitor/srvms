...
<script>
    ...
    function paySms() {
        ...
        // todo
        if (payment == 'wxpay') {
            window.open('http://lsdev.cnzhonglunnet.com//wxpay/entry/scanPay2SelfForServer.action?shopcodecharge=' + shopcode + '&businesscode=' + billcode + '&payamount=' + payamount + '&businessorigin=srvms-serverRecharge') ;
        } else {
            window.open('http://lsdev.cnzhonglunnet.com//alipay/entry/scanPay2SelfForServer.action?shopcodecharge=' + shopcode + '&businesscode=' + billcode + '&payamount=' + payamount + '&businessorigin=srvms-serverRecharge') ;
        }
    }
