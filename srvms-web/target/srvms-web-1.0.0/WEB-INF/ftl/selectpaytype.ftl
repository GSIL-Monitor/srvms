                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" readonly="" name="orderCode" id="orderCode" value="D2_20180423759">
                                </div>
                                ...
                                <div class="col-md-2">
                                    <input class="form-control" readonly="" name="totalprice" id="totalprice" value="0.02">
                                </div>
            ...
            <div class="panel-body cashier_body">
                ...
                <div class="cashier_item disableitem" onclick="select_cashier_item(this)">
                    <input type="checkbox" name="cashier_selection" class="cashier_selection"
                           onclick="select_cashier_item(this)">
                    <img src="http://dev.cnzhonglunnet.com:8080/images/union_pay.png">
...
<script>
    ...
    function paySms() {
        ...
        // todo
        if (payment == 'wxpay') {
            window.location.href = 'http://lsdev.cnzhonglunnet.com//entry/wxpay/scanPay2Self.action?shopcode=' + shopcode + '&businesscode=' + billcode + '&payamount=' + payamount + '&businessorigin=srvms-serverRecharge' ;
        } else {
            window.location.href = 'http://lsdev.cnzhonglunnet.com//entry/alipay/scanPay2Self.action?shopcode=' + shopcode + '&businesscode=' + billcode + '&payamount=' + payamount + '&businessorigin=srvms-serverRecharge' ;
        }
    }
