...
<form id="single_shop_form" method="post">
    <#import "../pager.ftl" as q>
			                    <@q.pager page=pageInfo.page pageSize=pageInfo.pageSize totalRecords=pageInfo.totalRecords toURL="${ctxPath}/renew/chooseShop/findallShop.action" pageid="single_shop_form"/>
</form>
</#if>