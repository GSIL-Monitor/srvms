            ...
            <li class="dd-item" data-id="${root.id}">
                <div class="dd-handle" style="width:100%;">
                    ...
                    <span class="pull-right">
                        ...
                        <a class="btn btn-default  btn-sm tooltips" href="javascript:void(0)" onclick="deleteItem('${root.id}','${root.level}')" data-original-title title="删除" onclick=""><i class="fa fa-remove"></i></a>
                    </span>
                </div>
