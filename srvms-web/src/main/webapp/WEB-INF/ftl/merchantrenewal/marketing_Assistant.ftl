    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $("body").on('change', '.branchItemChild :checkbox', function(e){
                ...
                var saleassistantcode = $(this).attr("saleassistantcode");
                ...
                appendHTML += '<input hidden type = "text" name="saleassistantcode" value="'+ saleassistantcode +'"/>'
        ...
        function queryMultipleShop() {
            ...
            var url = '${ctxPath}/renew/chooseShop/findMultipleShop.action?type=5';
            var params = {
                keyword:keyword
            };
            ajaxSyncInSameDomain(url, params, function (result) {
                ...
                for (var i = 0; i < length; i++){
                    ...
                    var branchList = json[i].codeList;
                    ...
                    for (var j = 0; j < branchlength; j++) {
                        ...
                        html += '   <input type="checkbox" ' +
                                ...
                                'saleassistantcode="'+ branchList[j].saleassistantcode+'" ' +
                                'value="'+json[i].shopcode + '-'+branchList[j].saleassistantcode +'">';

                        html += '   <span class="mr15">'+branchList[j].saleassistantcode+'</span>';
                        // html += '   <span>'+branchList[j].saleassistantcode+'</span>';
                        html += '  </label>';
                        html += '</li>';
                    }
                    html += '</ul></li>';
        ...
        function finish() {
            ...
            $('.selectedBranchItem li').each(function () { // 所有的li标签
                ...
                $(this).find("input").each(function () { // li标签下所有的input标签
                    ...
                    switch (name){
                        ...
                        case "shopname" : shopname = value;
                            break;
                        case "saleassistantcode" : saleassistantcode = value;
                            break;
                ...
                html += '<tr id ="'+ shopcode + saleassistantcode +'" name="data">';
                html += ' <td> '+index+'</td>';
                html += ' <td> '+shopcode+'</td>';
                html += ' <td> '+shopname+'</td>';
                html += ' <td> '+saleassistantcode+'</td>';
                ...
                html += '<input type="text" hidden name="saleassistantcode" value="'+ saleassistantcode+'" />';
                ...
                for (var i = 0 ; i < allYeas.length ;i++){
                    html += "<input class='yearRadio' type='radio' onclick='radioClick(this)' name = '"+ shopcode + saleassistantcode +"' price='"+ allYeas[i].price +"' value='"+ allYeas[i].year +"'/>" +  allYeas[i].year +"年 &nbsp;&nbsp;"
                }
                html += '</td>';
                ...
                $(this).find("input").each(function () {
                    ...
                    switch (name){
                        ...
                        case "shopname": obj.shopname = $(this).val();
                            break;
                        case "saleassistantcode": obj.saleassistantcode = $(this).val();
                            break;
        ...
        function fix1submit() {
            window.location.href="${ctxPath}/wechattrenewal/wehcat/marketingAssistantadd.action?productcode=ZLRJ004&type='4'";
        }
            ...
            <div class="panel-body">
                <form action="${ctxPath}/renew/order/payAgainMerchantStandard.action" method="post" id="submitForm">
                 ...
                 <div class="col-md-12">
                        ...
                        <div class="col-md-12" style="padding-left: 0px ;">
                            <div class="col-md-8"  style="margin-bottom:15px;margin-top:15px;padding-left: 0px ;" >
                                <form action="${ctxPath}/wechattrenewal/wehcat/marketingAssistantadd.action?productcode=ZLRJ004&type='4'" method="get" id="submitwechatForm">
                                    <input type="radio" onclick="fix1submit()"   />购买新营销助手码
                                </form>
                            </div>
                            <div class="col-md-8"  style="margin-bottom:15px;margin-top:15px;padding-left: 0px ;" >
                                <form action="${ctxPath}/wechattrenewal/wehcat/marketingAssistant.action?productcode=ZLRJ004&type='4'" method="get" id="submittrenewalForm">
                                    <input type="radio" onclick="change()" checked="checked" />已有营销助手码续费
                    ...
                    <div class="col-md-12" style="padding-left: 0px">
                        <label class="control-label col-md-12"><h5 style="font-weight:bold"><img src="${ctxPath}/images/label.png" style="width: 5px;margin-right: 5px;"/>选择营销助手码</h5></label>
                        <div class="col-md-12" style="padding-bottom: 0px">
                            <div class="col-md-12" style="margin-bottom:15px;padding-left: 0px;">
                                <button type="button" class="btn btn-primary" onclick="multipleShop()"><span style="color: white">+添加营销助手码</span></button>
