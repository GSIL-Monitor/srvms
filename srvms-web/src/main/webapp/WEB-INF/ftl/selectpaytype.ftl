...
<script>
    ...
    function paySms() {
        ...
        // todo
        if (payment == 'wxpay') {
            window.location.href = '${zl.web.pays.domain}/entry/wxpay/scanPay2Self.action?shopcode=' + shopcode + '&businesscode=' + billcode + '&payamount=' + payamount + '&businessorigin=srvms-serverRecharge' ;
        } else {
            window.location.href = '${zl.web.pays.domain}/entry/alipay/scanPay2Self.action?shopcode=' + shopcode + '&businesscode=' + billcode + '&payamount=' + payamount + '&businessorigin=srvms-serverRecharge' ;
        }
    }
